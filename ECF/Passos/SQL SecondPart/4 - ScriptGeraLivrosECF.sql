...
Declare @Empresa char(2), @DataIni smalldatetime, @DataFin smalldatetime, @Cliente varchar(18),
     @Estado Varchar(02)
...
set @Empresa = ( Select Top 1 E99.Codigo_Empresas From Loj_ECF_E99 E99 )
set @DataIni = '20171201'
set @DataFin = '20171231'
